...
3. Откройте в браузере: http://localhost:52847

> **Примечание:** Используется порт 52847 — это редкий порт, который не будет конфликтовать с веб-серверами и другими приложениями.
